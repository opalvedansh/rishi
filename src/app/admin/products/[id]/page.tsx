...
import { updateProduct, Product } from "@/lib/supabase/products";
        ...
        <div className="max-w-6xl mx-auto pb-20">
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div className="flex-1">
                    <h1 className="font-display text-2xl lg:text-3xl font-bold text-neutral-900">Edit Product</h1>
                    <p className="text-neutral-500 text-sm">Update product details and images.</p>
                </div>
                <button
                    type="button"
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-8 space-y-6">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-neutral-100 overflow-hidden">
                        ...
                        <div className="p-6 space-y-5">
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-neutral-700 mb-2">URL Handle</label>
                                <input
                                    type="text"
                                    ...
                                    placeholder={generateHandle(formData.title) || "product-handle"}
                                />
                                <p className="text-xs text-neutral-400 mt-2">
                                    URL: /products/{formData.handle || generateHandle(formData.title)}
                                </p>
                            </div>
                            <div>
                ...
                <div className="lg:col-span-4 space-y-6">
                    ...
                    <div className="sticky top-24 space-y-3">
                        ...
                        <Link
                            href="/admin/products"
                            className="w-full flex items-center justify-center gap-2 border-2 border-neutral-200 text-neutral-600 py-4 rounded-xl font-bold uppercase tracking-widest hover:bg-neutral-50 transition-all"
                        >
                            Cancel
                        </Link>
                    </div>
